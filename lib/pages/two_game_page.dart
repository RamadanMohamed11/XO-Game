...
class TwoGamePage extends StatefulWidget {
  const TwoGamePage({super.key, required this.xName, required this.oName});
  final String xName;
  final String oName;
  @override
  State<TwoGamePage> createState() => _TwoGamePageState();
}

class _TwoGamePageState extends State<TwoGamePage> {
